...
(lib.トゥイーン23 = function(mode,startPosition,loop) {
	...
	// レイヤー 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#BB0000").s().p("");
	this.shape.setTransform(0.2,-6.5);
...
(lib.トゥイーン21 = function(mode,startPosition,loop) {
	...
	// レイヤー 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#BB0000").s().p("");
...
p.nominalBounds = new cjs.Rectangle(-678.9,-239.4,450,663.2);
...
(lib.ShareButtons = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Button_Hatena
	this.instance = new lib.Button_Hatena();
	this.instance.setTransform(496.8,397.2,0.139,0.139,0,0,0,157.2,143.2);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(3).to({_off:false},0).to({scaleX:0.81,scaleY:0.81,x:553.2,y:406},4).wait(1));

	// Button_GooglePlus
	this.instance_1 = new lib.Button_GooglePlus();
	this.instance_1.setTransform(213.6,392.4,0.214,0.214,0,0,0,154,140.2);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(2).to({_off:false},0).to({regX:154.1,scaleX:0.8,scaleY:0.8,x:255.2,y:393.5},4).wait(2));

	// Button_Twitter
	this.instance_2 = new lib.Button_Twitter();
	this.instance_2.setTransform(541.6,139.8,0.165,0.165,0,0,0,150.1,152.2);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).to({regX:150,regY:152.3,scaleX:0.8,scaleY:0.8,x:468.7,y:145},4).wait(3));

	// Button_FaceBook
	this.instance_3 = new lib.Button_FaceBook();
	this.instance_3.setTransform(167.2,137.1,0.144,0.144,0,0,0,152.1,131.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:152.2,regY:132.1,scaleX:0.89,scaleY:0.89,x:152.2,y:132.1},4).wait(4));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(145.3,118.1,43.8,38.1);
...
p.nominalBounds = new cjs.Rectangle(0,61.3,2008.9,3499.3);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{Scene001_start:0,Scene001_stop:128,Scene002_start:145,Scene002_stop:164,Scene003_start:176,Scene003_stop:194,Scene004_start:204,Scene004_stop:363,Scene005_start:384,Scene005_stop:499,Scene006_start:508,Scene006_stop:638,"Scene001_start":0,"Scene001_stop":128,"Scene002_start":145,"Scene002_stop":164,"Scene003_start":176,"Scene003_stop":194,"Scene004_start":204,"Scene004_stop":363,"Scene005_start":384,"Scene005_stop":499,"Scene006_start":508,"Scene006_stop":638});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({y:797.6},81).wait(64).to({y:872.6},11).wait(20).to({y:756},8).wait(20).to({y:940},7).wait(173).to({y:936},0).to({y:622.4},11).wait(113).to({y:902.9},8).wait(138));
...
p.nominalBounds = new cjs.Rectangle(-59.7,-59.7,119.4,119.4);


(lib.Background = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{"Scene001_start":0,"Scene001_stop":128,"Scene002_start":145,"Scene002_stop":164,"Scene003_start":176,"Scene003_stop":194,"Scene004_start":204,"Scene004_stop":363,"Scene005_start":384,"Scene005_stop":499,"Scene006_start":508,"Scene006_stop":645});

	// ex
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("AgmCcQgDgDABgEIABgEQAAgBAAAAQAAAAAAgBQABAAAAgBQABAAAAgBQALgKAHgJQAIgKAGgNQAGgPAFgRQAFgQAEgRQACgRABgQQAAgagGgbQgGgcgKgXQgMgXgQgPIgCgDIgBgFQAAgEADgDQADgCAEAAQAGgBAIAJQAIAGAHANQAMASAIAWQAJAWAEAYQAFAZAAAVQgBAYgGAaQgGAbgLAXQgLAXgMAQQgIAKgGAFQgHAFgFgBQgEAAgDgDg");
	this.shape.setTransform(1198.3,1028.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("");
	this.shape_1.setTransform(1176.7,1025.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("");
	this.shape_2.setTransform(1146.9,1024.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("");
	this.shape_3.setTransform(1117,1024.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("");
	this.shape_4.setTransform(1087.2,1023.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#333333").s().p("");
	this.shape_5.setTransform(1298.4,974.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#333333").s().p("");
	this.shape_6.setTransform(1267.2,974.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("");
	this.shape_7.setTransform(1238,974.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#333333").s().p("");
	this.shape_8.setTransform(1207.5,974);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#333333").s().p("");
	this.shape_9.setTransform(1178.3,972.9);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#333333").s().p("");
	this.shape_10.setTransform(1148,972);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#333333").s().p("");
	this.shape_11.setTransform(1118.1,972.3);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#333333").s().p("");
	this.shape_12.setTransform(1088.1,971.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#333333").s().p("");
	this.shape_13.setTransform(1315.3,922.5);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#333333").s().p("");
	this.shape_14.setTransform(1285.8,922.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#333333").s().p("");
	this.shape_15.setTransform(1254.9,922.3);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#333333").s().p("");
	this.shape_16.setTransform(1226.1,921.4);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#333333").s().p("");
	this.shape_17.setTransform(1195.4,921.1);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#333333").s().p("");
	this.shape_18.setTransform(1165.5,919.6);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#333333").s().p("");
	this.shape_19.setTransform(1135.9,919.9);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#333333").s().p("");
	this.shape_20.setTransform(1105.3,919);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#333333").s().p("AAMCYQgIgHgHgNQgLgRgJgXQgJgXgEgYQgFgYABgVQAAgZAHgaQAFgaALgXQALgXAMgQQAIgKAGgFQAHgFAFABQAEAAADADQADADAAAEIgBAEIgDADIgNANIgKAOIgJAQQgJAWgGAaQgHAaAAAYQgBATAEAVQAEAVAHATQAEATAKAQQAJAQALAKIAEAEIABAEQgBAFgDADQgDACgEABQgGgBgIgHg");
	this.shape_21.setTransform(1084.2,922);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#333333").s().p("AgVCdQgDgDgBgEIABgEIACgEQAKgLAGgKQAGgLAEgNQAHgPAEgRQAEgRABgSQACgRgBgOQgCgcgJgbQgIgagMgWQgNgWgSgOIgCgDIgBgEQAAgEACgDQADgEAEAAQAGAAAJAHQAJAGAJAMQALAQAKAWQALAWAGAXQAIAYABAXQACAWgFAbQgEAbgIAYQgJAYgNARQgHAKgEAFQgGAGgFAAQgFAAgCgCg");
	this.shape_22.setTransform(1242.2,426);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#333333").s().p("");
	this.shape_23.setTransform(1226.4,423.6);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#333333").s().p("AhIBkQgegegEg8QgCglAMgfQAMgeAXgSQAXgTAggCQAegCAZAPQAZAOAPAcQAPAcADAnQACAkgMAeQgLAdgYASQgXARghADIgHAAQgsAAgbgcgAgEhkQgXACgRAPQgQAPgJAYQgJAYACAcQADAxAVAXQAUAXAlgDQAXgBARgPQAQgOAJgXQAJgXgCgbQgCgfgLgVQgLgXgSgLQgRgLgTAAIgDAAg");
	this.shape_24.setTransform(1202.2,425.1);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#333333").s().p("");
	this.shape_25.setTransform(1174.7,427.1);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#333333").s().p("");
	this.shape_26.setTransform(1145.3,428.2);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#333333").s().p("");
	this.shape_27.setTransform(1115.3,431.1);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#333333").s().p("");
	this.shape_28.setTransform(1338.8,364);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#333333").s().p("");
	this.shape_29.setTransform(1308.6,366);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#333333").s().p("");
	this.shape_30.setTransform(1278.1,367.5);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#333333").s().p("");
	this.shape_31.setTransform(1248.4,370);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#333333").s().p("");
	this.shape_32.setTransform(1219,371.3);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#333333").s().p("");
	this.shape_33.setTransform(1188.6,374.2);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#333333").s().p("");
	this.shape_34.setTransform(1158.5,375.4);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#333333").s().p("");
	this.shape_35.setTransform(1129,377.9);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#333333").s().p("");
	this.shape_36.setTransform(1107.9,381.8);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#333333").s().p("");
	this.shape_37.setTransform(1309.5,856.1);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#333333").s().p("");
	this.shape_38.setTransform(1269.6,853.6);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#333333").s().p("");
	this.shape_39.setTransform(1225.8,855);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#333333").s().p("");
	this.shape_40.setTransform(1183.4,853.3);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("#333333").s().p("");
	this.shape_41.setTransform(1143.4,851.5);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("#333333").s().p("");
	this.shape_42.setTransform(1098.9,851.3);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#333333").s().p("");
	this.shape_43.setTransform(1773.9,627.6);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("#333333").s().p("");
	this.shape_44.setTransform(1719.3,631.7);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f("#333333").s().p("");
	this.shape_45.setTransform(1664,637);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("#333333").s().p("");
	this.shape_46.setTransform(1603.6,643.1);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f("#333333").s().p("");
	this.shape_47.setTransform(1547.6,646.7);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f("#333333").s().p("");
	this.shape_48.setTransform(1489.9,652.1);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#333333").s().p("");
	this.shape_49.setTransform(1164.9,305.1);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#333333").s().p("");
	this.shape_50.setTransform(1112.5,308.6);
	...
	this.instance_6.setTransform(1203.5,938,1,1.768,0.6,0,0,195.9,96.5);

	this.instance_7 = new lib.WordFrame_in("synched",0,false);
	this.instance_7.setTransform(1640.4,631.9,1.142,1.032,-3.7,0,0,195.9,96.6);

	this.instance_8 = new lib.WordFrame_in("synched",0,false);
	this.instance_8.setTransform(1223,366.1,1,1.411,-3.2,0,0,196,96.5);

	this.instance_9 = new lib.Nobuteru_Back_upper();
	this.instance_9.setTransform(483.5,647.6,1.091,1.091,-5.2,0,0,224.2,506.1);

	this.instance_10 = new lib.CroutonShowers("synched",0,false);
	this.instance_10.setTransform(588.6,216.5,1,1,0,0,0,45.1,45.3);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6}]},156).to({state:[]},20).to({state:[{t:this.instance_9}]},46).to({state:[]},107).to({state:[{t:this.instance_10}]},126).to({state:[{t:this.instance_10}]},30).to({state:[{t:this.instance_10}]},13).to({state:[{t:this.instance_10}]},10).to({state:[{t:this.instance_10}]},9).to({state:[]},1).wait(137));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(455).to({_off:false},0).wait(30).to({startPosition:30},0).to({x:467.8,y:-52.3},13).wait(10).to({startPosition:29},0).to({x:-594.6},9).to({_off:true},1).wait(137));

	// Cup
	this.instance_11 = new lib.Cup();
	this.instance_11.setTransform(2379.2,780.8,1,1,0,0,0,261.5,224);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(453).to({_off:false},0).to({x:830.4},6).wait(26).to({x:709.6,y:518.4},13).wait(10).to({x:-352.8},9).to({_off:true},1).wait(137));
	...
	this.instance_13.setTransform(1248.8,634.6,0.545,0.545,36.7,0,0,92.7,252.6);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(145).to({_off:false},0).to({_off:true,regX:92.7,regY:252.6,scaleX:0.55,scaleY:0.55,rotation:36.7,x:1248.8,y:634.6,mode:"independent"},6,cjs.Ease.get(1)).wait(504));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(145).to({_off:false},6,cjs.Ease.get(1)).wait(25).to({regX:92.5,x:1624.5,y:860.5,mode:"synched",startPosition:17},0).to({x:2106.6,y:760.5,startPosition:1},4).to({_off:true},4).wait(471));
	...
	this.instance_15.setTransform(427.2,820.1,1.11,1.109,0,0,-1.6,336.1,258.1);
	this.instance_15._off = true;

	this.instance_16 = new lib.Hemajiro_Banzai_a("synched",0);
	this.instance_16.setTransform(976.8,1082,0.243,0.35,0,0,-2.4,336.2,258);
	this.instance_16._off = true;

	this.instance_17 = new lib.Hemajiro_Banzai("synched",0);
	this.instance_17.setTransform(976.8,1082,0.243,0.35,0,0,-2.4,336.2,258);
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(111).to({_off:false},0).to({regX:336,regY:512.4,scaleX:0.7,scaleY:0.7,skewX:0,x:1012.3,y:1105.8},9,cjs.Ease.get(1)).wait(25).to({regY:258,scaleX:1,scaleY:1,x:970.2,y:1549.9,mode:"synched",startPosition:2},6).wait(25).to({x:-530.3,y:759.7,startPosition:5},0).to({x:2316.3,y:747.5,startPosition:4},6).wait(2).to({startPosition:6},0).to({_off:true,regX:336.1,regY:258.1,scaleX:1.11,scaleY:1.11,skewY:-1.6,x:427.2,y:820.1,mode:"independent"},7).wait(464));
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(184).to({_off:false},7).wait(13).to({x:407.2},0).to({_off:true,regX:336.2,regY:258,scaleX:0.24,scaleY:0.35,skewY:-2.4,x:976.8,y:1082,mode:"synched",startPosition:0},18).wait(297).to({_off:false,regX:336.1,regY:258.1,scaleX:1.11,scaleY:1.11,skewY:-1.6,x:-396.7,y:683.6,mode:"independent"},0).to({_off:true,regX:336.2,regY:258,scaleX:0.24,scaleY:0.35,skewY:-2.4,x:1060.8,y:1082,mode:"synched",startPosition:0},18).wait(118));
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(204).to({_off:false},18).to({_off:true},32).wait(231).to({_off:false,regX:357.3,regY:268.9,scaleX:0.54,scaleY:0.81,skewY:0,x:1067.8,y:530.1,mode:"independent"},13).wait(10).to({x:1112.6,y:1643.7},9).to({_off:true},1).wait(1).to({_off:false,regX:336.2,regY:258,scaleX:0.24,scaleY:0.35,skewY:-2.4,x:1060.8,y:1082,mode:"synched",startPosition:0},18).to({_off:true},27).wait(91));
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(254).to({_off:false},0).wait(16).to({startPosition:16},0).to({regY:258.1,scaleX:0.43,scaleY:0.45,skewX:10.4,skewY:3.2,x:644.9,y:1088.2,startPosition:23},10).to({regX:336.3,scaleX:0.34,scaleY:0.45,skewX:8.2,skewY:3.8,x:636,y:1083.6,startPosition:24},13).to({regX:336.2,scaleX:0.46,scaleY:0.45,skewX:11,skewY:2.8,x:817.7,y:1078.5,startPosition:25},5).to({scaleX:0.43,scaleY:0.45,skewX:10.4,skewY:3.2,x:2279.6,y:989,startPosition:16},18).to({_off:true},47).wait(122).to({_off:false,regX:357.3,regY:268.8,scaleX:1,scaleY:1,skewX:0,skewY:0,x:1284.6,y:1643.6,startPosition:0},0).to({_off:true,regY:268.9,scaleX:0.54,scaleY:0.81,x:1067.8,y:530.1,mode:"independent"},13).wait(66).to({_off:false,regX:336.2,regY:258,scaleX:0.24,scaleY:0.35,skewY:-2.4,x:1060.8,y:1082,mode:"synched",startPosition:16},0).to({regY:258.1,scaleX:0.43,scaleY:0.45,skewX:10.4,skewY:3.2,x:728.9,y:1088.2,startPosition:23},10).to({regX:336.3,scaleX:0.34,scaleY:0.45,skewX:8.2,skewY:3.8,x:720,y:1083.6,startPosition:24},13).to({regX:336.2,scaleX:0.46,scaleY:0.45,skewX:11,skewY:2.8,x:901.7,y:1078.5,startPosition:25},5).to({scaleX:0.43,scaleY:0.45,skewX:10.4,skewY:3.2,x:2363.6,y:989,startPosition:16},18).wait(45));

	// Tuna
	this.instance_18 = new lib.Tuna();
	this.instance_18.setTransform(2178.1,909.7,0.597,0.663,0,0,0,359.9,219.5);
	this.instance_18._off = true;

	this.instance_19 = new lib.Tuna_move();
	this.instance_19.setTransform(1653.3,887.7,0.663,0.663,0,0,0,360,219.5);
	this.instance_19._off = true;

	this.instance_20 = new lib.Tuna_spring("synched",1);
	this.instance_20.setTransform(1019.2,918.9,0.537,0.687,0,3.3,6.8,360.1,219.5);

	this.instance_21 = new lib.Tuna_spring_attack("synched",1);
	this.instance_21.setTransform(1019.2,918.9,0.537,0.687,0,3.3,6.8,360.1,219.5);
	this.instance_21._off = true;

	this.instance_22 = new lib.Tuna_spring_stuck("synched",0);
	this.instance_22.setTransform(701.6,892.8,0.933,0.896,0,14.8,10,304,236.8);
	this.instance_22._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_18}]},145).to({state:[{t:this.instance_19}]},11).to({state:[{t:this.instance_19}]},20).to({state:[{t:this.instance_19}]},8).to({state:[]},1).to({state:[{t:this.instance_19}]},19).to({state:[{t:this.instance_19}]},8).to({state:[{t:this.instance_20,p:{x:1019.2}}]},10).to({state:[{t:this.instance_21}]},32).to({state:[{t:this.instance_21}]},16).to({state:[{t:this.instance_22}]},10).to({state:[{t:this.instance_22}]},13).to({state:[{t:this.instance_22}]},5).to({state:[{t:this.instance_22}]},18).to({state:[]},47).to({state:[{t:this.instance_19}]},156).to({state:[{t:this.instance_19}]},8).to({state:[{t:this.instance_20,p:{x:1103.2}}]},10).to({state:[{t:this.instance_21}]},27).to({state:[{t:this.instance_22}]},10).to({state:[{t:this.instance_22}]},13).to({state:[{t:this.instance_22}]},5).to({state:[{t:this.instance_22}]},18).wait(45));
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(145).to({_off:false},0).to({_off:true,regX:360,scaleX:0.66,x:1653.3,y:887.7},11).wait(499));
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(145).to({_off:false},11).wait(20).to({y:899.7},0).to({regY:219.6,scaleX:0.63,scaleY:0.56,x:-226.7,y:797.4},8).to({_off:true},1).wait(19).to({_off:false,regY:219.5,scaleX:1,scaleY:1,x:2361,y:-252},0).to({regX:359.9,scaleX:0.8,scaleY:0.78,skewX:1.5,skewY:-178.5,x:655,y:412.2},8,cjs.Ease.get(1)).to({_off:true,regX:360.1,scaleX:0.54,scaleY:0.69,skewX:3.3,skewY:-353.2,x:1019.2,y:918.9,mode:"synched",startPosition:1},10,cjs.Ease.get(-1)).wait(297).to({_off:false,regX:360,scaleX:1,scaleY:1,skewX:0,skewY:-360,x:2565,y:-252,mode:"independent"},0).to({regX:359.9,scaleX:0.8,scaleY:0.78,skewX:1.5,skewY:-538.5,x:859,y:412.2},8,cjs.Ease.get(1)).to({_off:true,regX:360.1,scaleX:0.54,scaleY:0.69,skewX:3.3,skewY:-713.2,x:1103.2,y:918.9,mode:"synched",startPosition:1},10,cjs.Ease.get(-1)).wait(118));
	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(254).to({_off:false},0).wait(16).to({startPosition:17},0).to({_off:true,regX:304,regY:236.8,scaleX:0.93,scaleY:0.9,skewX:14.8,skewY:10,x:701.6,y:892.8,startPosition:0},10).wait(284).to({_off:false,regX:360.1,regY:219.5,scaleX:0.54,scaleY:0.69,skewX:3.3,skewY:6.8,x:1103.2,y:918.9,startPosition:17},0).to({_off:true,regX:304,regY:236.8,scaleX:0.93,scaleY:0.9,skewX:14.8,skewY:10,x:785.6,y:892.8,startPosition:0},10).wait(81));
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(270).to({_off:false},10).to({regX:303.9,scaleX:0.75,scaleY:0.88,skewX:11.8,skewY:12.3,x:681,y:888.3,startPosition:1},13,cjs.Ease.get(1)).to({scaleX:1,scaleY:0.9,skewX:15.6,skewY:9.1,x:878.2,y:883.2,startPosition:2},5).to({regX:304,scaleX:0.93,scaleY:0.9,skewX:14.8,skewY:10,x:2336.3,y:793.6,startPosition:4},18).to({_off:true},47).wait(201).to({_off:false,x:785.6,y:892.8,startPosition:0},10).to({regX:303.9,scaleX:0.75,scaleY:0.88,skewX:11.8,skewY:12.3,x:765,y:888.3,startPosition:1},13,cjs.Ease.get(1)).to({scaleX:1,scaleY:0.9,skewX:15.6,skewY:9.1,x:962.2,y:883.2,startPosition:2},5).to({regX:304,scaleX:0.93,scaleY:0.9,skewX:14.8,skewY:10,x:2420.3,y:793.6,startPosition:4},18).wait(45));

	// Panel
	this.instance_23 = new lib.Panel("synched",0,false);
	this.instance_23.setTransform(504.1,747.2,1,1.003,0,-19.4,-15,52.9,83);
	this.instance_23._off = true;

	this.instance_24 = new lib.Nobuter_panel("synched",0,false);
	this.instance_24.setTransform(383.2,372.3,1,1,0,0,0,1010.9,1784.1);

	this.instance_25 = new lib.Nobuter_panel_rattle("synched",0);
	this.instance_25.setTransform(383.2,372.3,1,1,0,0,0,1010.9,1784.1);
	this.instance_25._off = true;

	this.instance_26 = new lib.Panel_share("synched",0,false);
	this.instance_26.setTransform(588.1,747.2,1,1.003,0,-19.4,-15,52.9,83);
	this.instance_26._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_23}]},280).to({state:[{t:this.instance_23}]},49).to({state:[{t:this.instance_23}]},15).to({state:[{t:this.instance_24}]},40).to({state:[{t:this.instance_25}]},19).to({state:[{t:this.instance_25}]},40).to({state:[{t:this.instance_25}]},12).to({state:[{t:this.instance_25}]},17).to({state:[{t:this.instance_25}]},11).to({state:[]},1).to({state:[{t:this.instance_26}]},90).to({state:[{t:this.instance_26}]},49).to({state:[{t:this.instance_26}]},15).wait(17));
	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(280).to({_off:false},0).wait(49).to({startPosition:19},0).to({regX:52.8,scaleX:3.8,scaleY:3.81,x:526,y:700.4},15).to({_off:true},40).wait(271));
	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(403).to({_off:false},0).wait(40).to({startPosition:1},0).to({x:182.4,y:-646.6,mode:"independent"},12).wait(17).to({x:-726.4,y:-672.2},11).to({_off:true},1).wait(171));
	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(574).to({_off:false},0).wait(49).to({startPosition:19},0).to({regX:52.8,scaleX:10.05,scaleY:8.95,skewX:0.1,skewY:-9,x:691.6,y:868.3},15).wait(17));

	// Nobuteru
	this.instance_27 = new lib.Nobuteru_Appear();
	this.instance_27.setTransform(209.1,1222.6,1,0.058,0,57.2,0,227.3,937.6);
	this.instance_27._off = true;

	this.instance_28 = new lib.Nobuteru_Extrude();
	this.instance_28.setTransform(849,793.4,0.79,0.79,-5.2,0,0,224.1,506);
	this.instance_28._off = true;

	this.instance_29 = new lib.Nobuteru_Back();
	this.instance_29.setTransform(-203.3,567.7,0.79,0.79,-5.2,0,0,224.1,506);
	this.instance_29._off = true;

	this.instance_30 = new lib.Nobuteru_Back_swing("single",0);
	this.instance_30.setTransform(483.6,647.6,1.091,1.091,-5.2,0,0,224.3,506.1);

	this.instance_31 = new lib.Nobuteru_Back_shock("synched",0);
	this.instance_31.setTransform(483.6,647.6,1.091,1.091,-5.2,0,0,224.3,506.1);

	this.instance_32 = new lib.Nobuteruru_rolling();
	this.instance_32.setTransform(483.6,647.7,1.091,1.091,-5.2,0,0,224.3,506.2);
	this.instance_32._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_27}]},115).to({state:[{t:this.instance_27}]},9).to({state:[{t:this.instance_27}]},21).to({state:[{t:this.instance_27}]},6).to({state:[{t:this.instance_27}]},25).to({state:[{t:this.instance_27}]},4).to({state:[{t:this.instance_27}]},4).to({state:[{t:this.instance_28}]},7).to({state:[{t:this.instance_28}]},13).to({state:[{t:this.instance_29}]},8).to({state:[{t:this.instance_29}]},3).to({state:[{t:this.instance_30,p:{x:483.6}}]},7).to({state:[{t:this.instance_31,p:{x:483.6}}]},58).to({state:[{t:this.instance_32}]},18).to({state:[{t:this.instance_32}]},31).to({state:[{t:this.instance_32}]},15).to({state:[]},40).to({state:[{t:this.instance_29}]},143).to({state:[{t:this.instance_29}]},3).to({state:[{t:this.instance_30,p:{x:567.6}}]},7).to({state:[{t:this.instance_30,p:{x:567.6}}]},27).to({state:[{t:this.instance_31,p:{x:567.6}}]},10).to({state:[{t:this.instance_32}]},18).to({state:[{t:this.instance_32}]},31).to({state:[{t:this.instance_32}]},15).wait(17));
	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(115).to({_off:false},0).to({regX:227.2,regY:937.4,scaleX:0.79,scaleY:0.79,skewX:0,x:434.3,y:1193},9,cjs.Ease.get(1)).wait(21).to({regX:224.2,regY:506.1,scaleX:0.42,scaleY:0.42,rotation:-43.2,x:1717,y:373.6},6).wait(25).to({regY:505.9,scaleX:0.54,scaleY:0.54,x:1345.1,y:513.2,mode:"synched",startPosition:0},0).to({x:2263.3,y:387.2,startPosition:3},4).wait(4).to({startPosition:7},0).to({_off:true,regX:224.1,regY:506,scaleX:0.79,scaleY:0.79,rotation:-5.2,x:849,y:793.4,mode:"independent"},7).wait(464));
	this.timeline.addTween(cjs.Tween.get(this.instance_28).wait(184).to({_off:false},7).wait(13).to({rotation:-5.2},0).to({_off:true,x:-203.3,y:567.7},8).wait(443));
	this.timeline.addTween(cjs.Tween.get(this.instance_29).wait(204).to({_off:false},8).wait(3).to({_off:true,regX:224.3,regY:506.1,scaleX:1.09,scaleY:1.09,x:483.6,y:647.6,mode:"single",startPosition:0},7).wait(305).to({_off:false,regX:224.1,regY:506,scaleX:0.79,scaleY:0.79,x:-188,y:547.6,mode:"independent"},0).wait(3).to({x:0.7,y:567.7},0).to({_off:true,regX:224.3,regY:506.1,scaleX:1.09,scaleY:1.09,x:567.6,y:647.6,mode:"single",startPosition:0},7).wait(118));
	this.timeline.addTween(cjs.Tween.get(this.instance_32).wait(298).to({_off:false},0).wait(31).to({regY:506.1,scaleX:4.14,scaleY:4.14,x:448.4,y:322.3},15).to({_off:true},40).wait(208).to({_off:false,regY:506.2,scaleX:1.09,scaleY:1.09,x:567.6,y:647.7},0).wait(31).to({regY:506.1,scaleX:10.52,scaleY:10.39,rotation:0,skewX:14.9,skewY:-0.1,x:792.4,y:30.7},15).wait(17));

	// dameo.png
	this.instance_33 = new lib.Dameo_Swing();
	this.instance_33.setTransform(1585.9,1101.1,1,0.016,0,61.9,0,285.4,462.3);
	this.instance_33._off = true;

	this.instance_34 = new lib.Dameo_NoHand();
	this.instance_34.setTransform(857.9,934.3,0.955,0.955,0,0,0,285.5,232);

	this.instance_35 = new lib.Dameo_Banzai("synched",0);
	this.instance_35.setTransform(1069.1,1099,0.224,0.323,0,0,0,285.4,232.1);
	this.instance_35._off = true;

	this.instance_36 = new lib.Dameo_Banzai_attack("synched",0);
	this.instance_36.setTransform(1069.1,1099,0.224,0.323,0,0,0,285.4,232.1);
	this.instance_36._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_33}]},107).to({state:[{t:this.instance_33}]},10).to({state:[{t:this.instance_33}]},28).to({state:[{t:this.instance_33}]},6).to({state:[{t:this.instance_33}]},25).to({state:[{t:this.instance_33}]},6).to({state:[{t:this.instance_33}]},2).to({state:[{t:this.instance_34}]},7).to({state:[{t:this.instance_33}]},13).to({state:[{t:this.instance_35}]},18).to({state:[{t:this.instance_36}]},32).to({state:[{t:this.instance_36}]},16).to({state:[{t:this.instance_36}]},10).to({state:[{t:this.instance_36}]},13).to({state:[{t:this.instance_36}]},5).to({state:[{t:this.instance_36}]},18).to({state:[]},47).to({state:[{t:this.instance_35}]},122).to({state:[{t:this.instance_35}]},13).to({state:[{t:this.instance_35}]},10).to({state:[{t:this.instance_35}]},9).to({state:[]},1).to({state:[{t:this.instance_33}]},1).to({state:[{t:this.instance_35}]},18).to({state:[{t:this.instance_36}]},27).to({state:[{t:this.instance_36}]},10).to({state:[{t:this.instance_36}]},13).to({state:[{t:this.instance_36}]},5).to({state:[{t:this.instance_36}]},18).wait(45));
	this.timeline.addTween(cjs.Tween.get(this.instance_33).wait(107).to({_off:false},0).to({regY:463.8,scaleX:0.63,scaleY:0.63,skewX:0,x:694,y:1054.9},10,cjs.Ease.get(1)).wait(28).to({regX:285.5,regY:232,scaleX:1,scaleY:1,x:-204.3,y:1430.3,mode:"synched",startPosition:2},6).wait(25).to({x:-330.3,y:536.2,startPosition:5},0).to({x:2247.5,y:478.1,startPosition:4},6).wait(2).to({startPosition:6},0).to({_off:true,scaleX:0.96,scaleY:0.96,x:857.9,y:934.3,mode:"independent"},7).wait(13).to({_off:false},0).to({_off:true,regX:285.4,regY:232.1,scaleX:0.22,scaleY:0.32,x:1069.1,y:1099,mode:"synched",startPosition:0},18).wait(297).to({_off:false,regX:285.5,regY:232,scaleX:0.96,scaleY:0.96,x:2423.2,y:669.3,mode:"independent"},0).to({_off:true,regX:285.4,regY:232.1,scaleX:0.22,scaleY:0.32,x:1153.1,y:1099,mode:"synched",startPosition:0},18).wait(118));
	this.timeline.addTween(cjs.Tween.get(this.instance_35).wait(204).to({_off:false},18).to({_off:true},32).wait(231).to({_off:false,regX:266.1,regY:220.5,scaleX:1,scaleY:1,x:351.2,y:-319.9},0).to({scaleX:0.63,scaleY:0.79,x:339.2,y:505.7,mode:"independent"},13).wait(10).to({y:-230.3},9).to({_off:true},1).wait(1).to({_off:false,regX:285.4,regY:232.1,scaleX:0.22,scaleY:0.32,x:1153.1,y:1099,mode:"synched",startPosition:0},18).to({_off:true},27).wait(91));
	this.timeline.addTween(cjs.Tween.get(this.instance_36).wait(254).to({_off:false},0).wait(16).to({startPosition:16},0).to({regX:285.3,regY:232,scaleX:0.39,scaleY:0.42,skewX:10.4,skewY:4.9,x:802.5,y:1123.7,startPosition:20},10).to({scaleX:0.4,scaleY:0.42,skewX:10.3,skewY:1.5,x:772.7,y:1095.9,startPosition:21},13).to({regY:232.1,scaleX:0.53,scaleY:0.42,skewX:13.6,skewY:1.2,x:1001.3,y:1092,startPosition:22},5).to({regY:232,scaleX:0.39,scaleY:0.42,skewX:10.4,skewY:4.9,x:2437.2,y:1024.5,startPosition:12},18).to({_off:true},47).wait(201).to({_off:false,regX:285.4,regY:232.1,scaleX:0.22,scaleY:0.32,skewX:0,skewY:0,x:1153.1,y:1099,startPosition:16},0).to({regX:285.3,regY:232,scaleX:0.39,scaleY:0.42,skewX:10.4,skewY:4.9,x:886.5,y:1123.7,startPosition:20},10).to({scaleX:0.4,scaleY:0.42,skewX:10.3,skewY:1.5,x:856.7,y:1095.9,startPosition:21},13).to({regY:232.1,scaleX:0.53,scaleY:0.42,skewX:13.6,skewY:1.2,x:1085.3,y:1092,startPosition:22},5).to({regY:232,scaleX:0.39,scaleY:0.42,skewX:10.4,skewY:4.9,x:2521.2,y:1024.5,startPosition:12},18).wait(45));

	// ex3
	this.instance_37 = new lib.Circle_anim_multiExtensions("synched",0);
	this.instance_37.setTransform(958,600,1,1,0,0,0,-2,0);
	this.instance_37._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_37).wait(145).to({_off:false},0).wait(31).to({startPosition:0},0).to({_off:true},15).wait(317).to({_off:false},0).to({_off:true},19).wait(128));

	// GridMaking
	this.instance_38 = new lib.GridMaking("synched",0,false);
	this.instance_38.setTransform(902.2,1138.5,1,1,0,0,0,902.3,1138.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_38).to({_off:true},115).wait(540));

	// bg
	this.instance_39 = new lib.トゥイーン1("synched",0);
	this.instance_39.setTransform(960,1200);

	this.timeline.addTween(cjs.Tween.get(this.instance_39).to({y:972.5},124).to({y:965.1},4).wait(17).to({startPosition:0},0).to({y:929.1},19).wait(12).to({startPosition:0},0).to({y:894.1},18).wait(10).to({startPosition:0},0).to({y:578.2},159).wait(21).to({startPosition:0},0).to({y:334.1},114).wait(10).to({startPosition:0},0).to({y:0},130).wait(17));
...
p.nominalBounds = new cjs.Rectangle(-1152.9,-720.9,3841.9,2881.9);

...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/lw.jpg", id:"lw"},
		{src:"images/nobuteru_clip.png", id:"nobuteru_clip"},
...
(lib.lw = function() {
	this.initialize(img.lw);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,145,170);


(lib.nobuteru_clip = function() {
	this.initialize(img.nobuteru_clip);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,110,118);
...
(lib.Osusume = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF2C12").s().p("AgNBQIAAgeIAbAAIAAAegAgGAkIgHhGIAAgtIAbAAIAAAtIgHBGg");
	this.shape.setTransform(-5.8,62.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF2C12").s().p("AgNBQIAAgeIAbAAIAAAegAgFAkIgIhGIAAgtIAbAAIAAAtIgIBGg");
	this.shape_1.setTransform(-27.8,62.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF2C12").s().p("");
	this.shape_2.setTransform(-49.8,62.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FF2C12").s().p("AhGA3QAWgLANgJQAOgKAJgJIANgQIgFgFIgLgKIgSgLIAPgVIASAPIAQANIALgTQAFgIADgJIAHgTIAYALIADACQAAAAABAAQAAAAAAABQABAAAAAAQAAABAAAAQAAAAAAAAQAAABgBAAQAAAAAAAAQgBAAAAAAIgEABIgIATIgJARIgNAVIAOANIAPASIgUATIgLgQIgOgPIgSATQgIAJgMAJQgMAJgRAKg");
	this.shape_3.setTransform(-72.4,62.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FF2C12").s().p("AhTA6IATgIQALgFANgKQAOgJAOgPQAMgLAFgLQAHgLAFgKIAGgPIhSAAIAAgZIBeAAQACAAADgCIAGgEIARATIgHAGIgFAIIgHAPIgHAPIgMARQAQAMAPAOIAbAcIgTAVIgbgfIgagYIgRATQgJAJgOAKQgNAIgVALg");
	this.shape_4.setTransform(-93.9,62.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FF2C12").s().p("AhSA6IASgIQALgFAOgKQANgJAOgPQAMgLAFgLQAIgLADgKIAIgPIhSAAIAAgZIBcAAQADAAADgCIAGgEIAQATIgGAGIgFAIIgHAPIgIAPIgLARQAQAMAOAOIAdAcIgUAVIgcgfIgagYIgQATQgKAJgNAKQgOAIgUALg");
	this.shape_5.setTransform(-115.9,62.5);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FF2C12").s().p("AgPA+IAGABIAJAAQAGAAACgBQADgCAAgDIgBg6QgJALgKAMQgLALgNAKQgNALgOAIIgTgTQARgIAPgLQAOgLALgNQALgKAIgNIhEAAIAAgXIBQAAIgBgqIAaABIADAAQAAABABAAQAAAAAAAAQABABAAAAQAAAAAAABIAAABIgCACIgCABIgBACIABAgIAtAAIAAAXIgsAAIABBSQAAANgEAHQgFAGgKACQgKACgNAAg");
	this.shape_6.setTransform(-138.1,62.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FF2C12").s().p("");
	this.shape_7.setTransform(148.1,27);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FF2C12").s().p("AhXBdIAAi5ICuAAIAAAXIhNAAIAAAcIA+AAIAABPIgaAAIAAgJIgjAAIAAAfIBNAAIAAAYIiWAAIAAAJgAg+A8IAxAAIAAgfIgxAAgAg+AIIBsAAIAAgaIhsAAgAg+gpIAwAAIAAgcIgwAAg");
	this.shape_8.setTransform(126.4,27.3);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FF2C12").s().p("AhiBMQAagKAPgNQARgOAJgSQAKgRAGgVIhNAAIAAgYIBPAAIABgKIAAgJIAAgFIgBgRIAAgNIAbACIADAAIABADIgBACIgDADIgBADIAAADIAAAHIAAAGIAAANIgBAMIBTAAIAAAYIhQAAQAFAPAGALQAGANAKALQAJALAOAKQAOAJAUAKIgXAVQgWgNgOgMQgNgMgJgOQgKgNgHgRQgIAVgLAPQgLAPgOAMQgOALgTAJg");
	this.shape_9.setTransform(104,27.2);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FF2C12").s().p("");
	this.shape_10.setTransform(82.2,27.1);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FF2C12").s().p("");
	this.shape_11.setTransform(60.1,27.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FF2C12").s().p("");
	this.shape_12.setTransform(37.7,26.9);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FF2C12").s().p("");
	this.shape_13.setTransform(16.2,27.4);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FF2C12").s().p("");
	this.shape_14.setTransform(-6.3,27.2);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FF2C12").s().p("");
	this.shape_15.setTransform(-28,27);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FF2C12").s().p("");
	this.shape_16.setTransform(-49.2,27);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FF2C12").s().p("");
	this.shape_17.setTransform(-71.8,27.1);
	...
	this.shape_18.setTransform(-93.5,27.3);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FF2C12").s().p("");
	this.shape_19.setTransform(-115.8,27.3);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FF2C12").s().p("AgOBOIgSgCIgQgEQgIgDgFgEIgFgHQgCgEAAgGQAAgLADgHQADgIAFgFIALgMIAUARIgGAFIgFAGIgCAHIABAGIACACQADACAHABIAPACIALAAIAegBIAVgCIARgDIABAbIggADIgkABIgPAAgAgIggIAVgTIgcAAIgUAAIgPgBIgFgZIAdADQAPABANAAIAYAAIAYgCIALASIgUAPIgTAPIgQANg");
	this.shape_20.setTransform(-138.1,27.2);
	...
	this.shape_21.setTransform(0,43);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-198.6,-2.5,397.2,91);


(lib.NobuteruFace = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー 1
	this.instance = new lib.face();
	this.instance.parent = this;
	this.instance.setTransform(0,0,2.106,2.106);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,77.9,111.6);


(lib.Nobuteru_tuna = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー 1
	this.instance = new lib.nobuteru_clip();
	this.instance.parent = this;
	this.instance.setTransform(-59.1,4.3,1,1,-4.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({rotation:8.5,x:-45.7,y:-7.4},0).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-59.1,-3.8,118.4,125.8);


(lib.Hayaku = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 経済再生担当大臣がカジキマグロを食い止めているうちに早くシェアするんだ！！
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF2C12").s().p("AgMBJIAAgbIAZAAIAAAbgAgFAhIgHhAIAAgpIAZAAIAAApIgHBAg");
	this.shape.setTransform(60.3,84.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF2C12").s().p("AgMBJIAAgbIAZAAIAAAbgAgFAhIgHhAIAAgpIAZAAIAAApIgHBAg");
	this.shape_1.setTransform(40.3,84.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF2C12").s().p("");
	this.shape_2.setTransform(20.4,83.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FF2C12").s().p("");
	this.shape_3.setTransform(0.4,83.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FF2C12").s().p("");
	this.shape_4.setTransform(-20,84);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FF2C12").s().p("");
	this.shape_5.setTransform(-39.7,84);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FF2C12").s().p("AhCA8QAVgOALgQQALgQAEgQQAEgRgBgVIAVABIAEAAIABACIAAABIgBAAIgBACIgCACIAAAEIgBAHIAAAGQgDATgFAQQgGAQgIAKQgJALgHAHIgLAJgAAIgCQAKgJAJgLQAKgKAIgOIh7AAIAAgVICEAAIAEgCIADgDIASATIgNATIgSAYIgVAVg");
	this.shape_6.setTransform(-59.5,84.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FF2C12").s().p("Ag6AzIAAgSIAxAAIAAhBIglAAIAAgSIBdAAIAAASIglAAIAABBIAxAAIAAASg");
	this.shape_7.setTransform(-79.7,85.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FF2C12").s().p("AgwBSIgCgDIgLgTQAZgLAVgNQATgNASgRQASgQARgYIAQATIgRAUQgLAOgUAQQgNALgMAJQgLAIgLAGIgTAJIgBABIgBABIgBAEIgBABIgDgDgAgygJQgJgEgNgFIALgUQAMAEAJAFQAKAFAJAHIgMARIgRgJgAgeg4IgUgIIALgTQALADAKAFQAKAFAIAGIgMAUQgIgHgKgFg");
	this.shape_8.setTransform(-99.5,84);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FF2C12").s().p("AAGA7IgVgXIgYgWQgGgEgCgGIgCgFQAAgGAFgGIAJgKIAZgYIASgUIATgVIASANIADADIACADQAAAAAAABQAAAAgBAAQAAAAAAAAQAAAAAAAAIgFABIgDABIgFAGIgJAIIgPAPIgSATIgJAJQgEADAAABIgBAEIABACIACACIAWAVIAWAWQALALALAOIgVATQgLgRgLgOg");
	this.shape_9.setTransform(-120.4,84);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FF2C12").s().p("AgMBUIAAgrIhJAAIAAgVIBJAAIAAgSIg3AAIAAhVICHAAIAABVIg4AAIAAASIBKAAIAAAVIhKAAIAAArgAgqgQIBWAAIAAgPIhWAAgAgqgyIBWAAIAAgNIhWAAg");
	this.shape_10.setTransform(-139.7,84.1);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FF2C12").s().p("");
	this.shape_11.setTransform(40.4,51.6);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FF2C12").s().p("");
	this.shape_12.setTransform(20.3,51.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FF2C12").s().p("AgdBFIAOgFQAJgDAGgGQAKgGAIgKQAHgIAEgKQAEgJAAgLQAAgHgEgFQgDgEgDgCIgIgCQgHAAgIADIgQAGIgRAIIgNAFIgJgWIAOgFIAVgHIAUgGQAMgDAJAAIAHABIAKADQAFACAEAFQAGAHABAHQACAIAAAHQABANgGAPQgFAPgKAMQgJAKgJAGQgJAHgJAEIgOAGgAAMg6IgRgCIgVgCIgBgZIAUAEIARACIAVABIgEAXIgPgBg");
	this.shape_13.setTransform(0.1,51.6);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FF2C12").s().p("");
	this.shape_14.setTransform(-20,51.7);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FF2C12").s().p("");
	this.shape_15.setTransform(-39.4,51.6);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FF2C12").s().p("AAVBOQgIgCgJgEQgHgEgIgHQgJgGgFgKQgFgJAAgOQAAgMAFgKQAEgLAHgJQAGgKAHgGIAIgKIglADIgmAFIgDgXIAkgCIAlgDIAmgGQARgDAPgFIAAAYIgKACQgIABgJAEQgJAEgKAJQgJAHgIAJQgIAJgCALQgGAIAAAKIABAIIAFAKQABAGAHAEIAMAHIANACIAJABIgHAZIgNgDg");
	this.shape_16.setTransform(-59.8,51.8);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FF2C12").s().p("");
	this.shape_17.setTransform(-79.7,51.7);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FF2C12").s().p("AhVBSIAAgVIAaAAIAAhsIAZABIABABIACABIgCACIgBABIgBABIgBACIAABjIAbAAIAAiOIAXACIACABIABABIAAABIgBABIgCACIgBACIAAAxIA8AAIAAAWIg8AAIAAA9IBJAAIAAAVg");
	this.shape_18.setTransform(-99.7,51.2);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FF2C12").s().p("");
	this.shape_19.setTransform(-119.4,51.6);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FF2C12").s().p("");
	this.shape_20.setTransform(-139.7,51.7);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FF2C12").s().p("");
	this.shape_21.setTransform(160.3,19.1);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FF2C12").s().p("AAtBBIAAgJIhZAAIAAAJIgYAAIAAiCICJAAIAACCgAgsAiIBZAAIAAhLIhZAAg");
	this.shape_22.setTransform(140.3,19.6);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FF2C12").s().p("");
	this.shape_23.setTransform(121.1,18.7);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FF2C12").s().p("AgHAlIgSgUIgRgPIAPgNIAMAJIALAIIATgUIATgUIhuAAIAAgWIB/AAIAFgCIAEgDIARATIgFAFIgEADIgIAIIgNANIgSARIgTAUIAJALIAIALIgVAQQgGgOgHgLg");
	this.shape_24.setTransform(100.4,19.8);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FF2C12").s().p("AgEAUIhCAJIgCgXIBAgGIgEgaIgxAHIgDgVIAwgGIgGgkIAVgBIACAAIACACIgCADIgBADIAFAaIArgGIADAVIgrAFIAFAaIA6gIIACAVIg5AHIALA+IgWAFg");
	this.shape_25.setTransform(80.3,19.3);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FF2C12").s().p("");
	this.shape_26.setTransform(60.7,18.9);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FF2C12").s().p("");
	this.shape_27.setTransform(40.2,19.2);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#FF2C12").s().p("");
	this.shape_28.setTransform(21.4,19.1);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FF2C12").s().p("AhPBVIAAioICeAAIAAAVIhFAAIAAAZIA3AAIAABHIgXAAIAAgIIggAAIAAAcIBGAAIAAAWIiIAAIAAAJgAg4A2IAsAAIAAgcIgsAAgAg4AHIBiAAIAAgYIhiAAgAg4glIAsAAIAAgZIgsAAg");
	this.shape_29.setTransform(0.5,19.5);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#FF2C12").s().p("AhZBFQAXgJAOgNQAQgLAIgRQAJgQAEgTIhEAAIAAgVIBHAAIABgJIAAgIIAAgGIAAgPIgBgLIAYACIADAAIABACIgBACIgDACIAAAEIAAACIAAAGIAAAGIgBAMIAAALIBMAAIAAAVIhKAAQAEAPAHAJQAFALAIAKQAJAKANAKQAMAIATAJIgVAUQgUgNgNgLQgMgLgIgMQgIgNgIgPQgHATgKAOQgKAOgNALQgMAKgSAIg");
	this.shape_30.setTransform(-19.8,19.5);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#FF2C12").s().p("");
	this.shape_31.setTransform(-39.6,19.3);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#FF2C12").s().p("");
	this.shape_32.setTransform(-59.8,19.3);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#FF2C12").s().p("AhQBSIAAgTIBLAAIAAgmIguAAIAAgVIAuAAIAAgeIgrAAIgIAOIgLAPIgVgKIAHgIIAGgJIAGgKQAHgOAEgLIAGgUIAVAGIAEABIABACIAAABIgCACIgDACIgCACIgCAHIgDAKIAhAAIAAgjIAWAAIAEABIABACIgBACIgBACIgDABIAAACIAAAZIA/AAIAAAUIg/AAIAAAeIAsAAIAAAVIgsAAIAAAmIBIAAIAAATg");
	this.shape_33.setTransform(-80.1,19.1);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#FF2C12").s().p("");
	this.shape_34.setTransform(-99.7,19.6);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#FF2C12").s().p("");
	this.shape_35.setTransform(-120.1,19.4);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#FF2C12").s().p("");
	this.shape_36.setTransform(-139.9,19.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	// レイヤー 1
	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f().s("#333333").ss(5,1,1).p("A3QoCMAyxAAAQDIAAAADwIAAIlQAADwjIAAMgyxAAAQjIAAAAjwIAAgpQi/AbhRhTQCIgVCIivIAAkAQAAjwDIAAg");
	this.shape_37.setTransform(0,52);

	this.timeline.addTween(cjs.Tween.get(this.shape_37).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-198.6,-2,397.2,108.1);
...
(lib.SharePig = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.Pig = function(mode,startPosition,loop) {
	...
	// レイヤー 5
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,0,0,0.298)").s().p("");
	this.shape.setTransform(2.5,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-67,-40.3,139,80.8);
...
(lib.Toha_in = function(mode,startPosition,loop) {
	...
	// レイヤー 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00FFFF").s().p("");
	this.shape.setTransform(-44.9,112.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#00FFFF").s().p("");
	this.shape_1.setTransform(55.4,121.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.shape},{t:this.shape_1}]},7).to({state:[]},4).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-123.8,0.7,172,214.3);
...
(lib.LW = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});

	// レイヤー 1
	this.instance = new lib.lw();
	this.instance.parent = this;
	this.instance.setTransform(-80.5,0);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-80.5,0,145,170);
...
(lib.Logo = function(mode,startPosition,loop) {
	...
	// レイヤー 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF9900").s().p("");
	this.shape.setTransform(57.5,46.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF9900").s().p("AgSAIIgQAAIgQAAIgMAAIgHgBQgDAAgBgCQgCgDAAgCQAAgDACgCQACgCAFAAIADAAIAEAAIAOAAIATABIBdgCQAEAAADACQACADAAADQAAACgCACQgBACgDABIgIAAIgQAAIgWABIgXAAIgTAAg");
	this.shape_1.setTransform(40.7,46.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF9900").s().p("");
	this.shape_2.setTransform(25,47.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FF9900").s().p("");
	this.shape_3.setTransform(9.1,47.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FF9900").s().p("AgSAIIgQAAIgQAAIgMAAIgHgBQgDAAgBgCQgCgDAAgCQAAgDACgCQACgCAFAAIADAAIAEAAIAOAAIATABIBdgCQAEAAADACQACADAAADQAAACgCACQgBACgDABIgIAAIgQAAIgWABIgXAAIgTAAg");
	this.shape_4.setTransform(-7.3,46.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FF9900").s().p("");
	this.shape_5.setTransform(-23.1,47.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FF9900").s().p("");
	this.shape_6.setTransform(-40.5,48.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FF9900").s().p("");
	this.shape_7.setTransform(-56.2,47.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FF6600").s().p("");
	this.shape_8.setTransform(59,27);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FF6600").s().p("");
	this.shape_9.setTransform(45.9,25.4);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FF6600").s().p("");
	this.shape_10.setTransform(30.3,25);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FF6600").s().p("");
	this.shape_11.setTransform(13.7,24.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#CD3CD4").s().p("AgYBDQgDgDABgEIABgEIACgDIACgBIADgBQAngOASgTQAUgSgBgaQAAgHgCgFQgCgGgEgDQgDgCgDgBIgJgCIgOgBIgTABIgUABIgZABIgXACIgBAAIgBAAQgEAAgBgCQgDgCAAgEIABgFIAEgDIACAAIAGgBIAEAAIAIAAIAbgCIAZgBIAYgBQAZAAAOALQAMALAAAVQAAAWgKAPQgJASgUAOIgPAJIgQAIIgOAHQgGADgDAAQgFAAgCgDg");
	this.shape_12.setTransform(-3.7,35.3);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#2CE904").s().p("");
	this.shape_13.setTransform(-17.8,22.1);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFF00").s().p("");
	this.shape_14.setTransform(-36.8,31.2);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FF2C12").s().p("");
	this.shape_15.setTransform(-54.4,26.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-68.1,0,136.2,63.6);
...
(lib.Circle = function(mode,startPosition,loop) {
	...
	// レイヤー 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(0,255,255,0.298)").ss(1,1,1).p("ACWAAQAAA+gsAsQgsAsg+AAQg9AAgsgsQgsgsAAg+QAAg9AsgsQAsgsA9AAQA+AAAsAsQAsAsAAA9g");
...
(lib.MenuPanel = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{"in":0,stop:37});

	// レイヤー 4
	this.instance = new lib.WhiteBox("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(384,240.1,0.02,0.027,0,0,0,0,222.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:221.1,scaleX:0.27,scaleY:0.24,y:381.5},3).wait(2).to({startPosition:0},0).to({regY:220.8,scaleX:0.29,scaleY:0.64,y:240.1},5).wait(5).to({y:227.6},0).to({regY:220.9,scaleX:1,scaleY:0.68,y:240.1},5).wait(5).to({startPosition:0},0).to({regY:220.8,scaleY:1,y:240},4).wait(39));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(377.7,234.1,12.6,11.8);


(lib.ShareAnim_nobuteru_tuna = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});

	// レイヤー 2
	this.instance = new lib.Hayaku("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(415.3,186.5,1,1,0,0,0,0,43);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(56).to({_off:false},0).to({_off:true},277).wait(74));

	// レイヤー 1
	this.instance_1 = new lib.Nobuteru_tuna("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(845,191,1,1,0,0,0,0,59);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:159,startPosition:3},56).wait(276).to({startPosition:3},0).to({x:-64.3,startPosition:1},18).to({_off:true},1).wait(56));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(785.9,128.2,118.4,125.8);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// レイヤー 2
	this.instance = new lib.Osusume("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(415.3,186.5,1,1,0,0,0,0,43);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({_off:false},0).to({_off:true},73).wait(74));

	// レイヤー 1
	this.instance_1 = new lib.NobuteruFace("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(815.1,189.1,1,1,0,0,0,39,55.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:154.1},19).wait(72).to({x:153.1},0).to({x:-71.9},18).to({_off:true},1).wait(56));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(776.1,133.3,77.9,111.6);
...
(lib.TU_in = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,0,1.404,1.404);
...
(lib.MainTitleText = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(68.1,25.4,1,1,0,0,0,0,31.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// レイヤー 2
	this.instance_1 = new lib.Pig("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(83.2,46.2,1.904,1.904,0,0,0,2.9,0.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-49.9,-31.7,264.5,153.7);
...
(lib.LineShoot = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,85,1,1,0,0,0,0,25);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleY:0.02,y:120.5},9,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-5,55,10,60);
...
(lib.ShareClips = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー 1
	this.instance = new lib.ShareAnim_nobuteru_tuna();
	this.instance.parent = this;
	this.instance.setTransform(0,55.8,1,1,0,0,0,0,55.8);

	this.instance_1 = new lib.ShareAnim_nobuteru();
	this.instance_1.parent = this;
	this.instance_1.setTransform(0,55.8,1,1,0,0,0,0,55.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(776.1,128.2,128.2,125.8);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#990000").s().p("Eg7/AlfMAAAhK+MB3+AAAMAAABK+g");
	this.shape_4.setTransform(384,240);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFF00").s().p("Eg7/AlfMAAAhK+MB3+AAAMAAABK+g");
	this.shape_5.setTransform(384,240);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FF9900").s().p("Eg7/AlfMAAAhK+MB3+AAAMAAABK+g");
	this.shape_6.setTransform(384,240);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#2CE904").s().p("Eg7/AlfMAAAhK+MB3+AAAMAAABK+g");
	this.shape_7.setTransform(384,240);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#669900").s().p("Eg7/AlfMAAAhK+MB3+AAAMAAABK+g");
	this.shape_8.setTransform(384,240);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FF33CC").s().p("Eg7/AlfMAAAhK+MB3+AAAMAAABK+g");
	this.shape_9.setTransform(384,240);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#9900CC").s().p("Eg7/AlfMAAAhK+MB3+AAAMAAABK+g");
	this.shape_10.setTransform(384,240);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("rgba(102,255,255,0.2)").s().p("Eg7/AlfMAAAhK+MB3+AAAMAAABK+g");
	this.shape_11.setTransform(384,240);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#BBFFFF").s().p("Eg7/AlfMAAAhK+MB3+AAAMAAABK+g");
	this.shape_12.setTransform(384,240);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFCC").s().p("Eg7/AlfMAAAhK+MB3+AAAMAAABK+g");
	this.shape_13.setTransform(384,240);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#66FFCC").s().p("Eg7/AlfMAAAhK+MB3+AAAMAAABK+g");
	this.shape_14.setTransform(384,240);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFCCFF").s().p("Eg7/AlfMAAAhK+MB3+AAAMAAABK+g");
	this.shape_15.setTransform(384,240);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3}]}).to({state:[{t:this.shape_4}]},1).to({state:[]},1).to({state:[{t:this.shape_5}]},3).to({state:[{t:this.shape_6}]},1).to({state:[]},1).to({state:[{t:this.shape_7}]},2).to({state:[{t:this.shape_8}]},1).to({state:[]},1).to({state:[{t:this.shape_9}]},2).to({state:[{t:this.shape_10}]},1).to({state:[]},1).to({state:[{t:this.shape_11}]},14).to({state:[{t:this.shape_12}]},1).to({state:[]},1).to({state:[{t:this.shape_3}]},5).to({state:[{t:this.shape_4}]},1).to({state:[]},1).to({state:[{t:this.shape_5}]},3).to({state:[{t:this.shape_13}]},1).to({state:[]},1).to({state:[{t:this.shape_7}]},2).to({state:[{t:this.shape_14}]},1).to({state:[]},1).to({state:[{t:this.shape_9}]},4).to({state:[{t:this.shape_15}]},1).to({state:[]},1).wait(2));
...
(lib.ExtendBlurs = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Circle__anim_extend_blur
	this.instance = new lib.Circle__anim_extend_blur("synched",0,false);
	this.instance.parent = this;
	this.instance.setTransform(-6.7,-7.1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).wait(12));

	// Circle__anim_extend_blur
	this.instance_1 = new lib.Circle__anim_extend_blur("synched",0,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-27.5,-12.7);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(3).to({_off:false},0).to({_off:true},12).wait(1));

	// Circle__anim_extend_blur
	this.instance_2 = new lib.Circle__anim_extend_blur("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-20,13);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(2).to({_off:false},0).to({_off:true},12).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({_off:false},0).to({_off:true},12).wait(3));

	// Circle__anim_extend_blur
	this.instance_4 = new lib.Circle__anim_extend_blur("synched",0,false);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-2,15);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({_off:true},12).wait(4));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-16,-1,32,32);
...
(lib.LineShootAround = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(7).to({_off:false},0).wait(10));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(6).to({_off:false},0).to({_off:true},10).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(5).to({_off:false},0).to({_off:true},10).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(4).to({_off:false},0).to({_off:true},10).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(3).to({_off:false},0).to({_off:true},10).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(2).to({_off:false},0).to({_off:true},10).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({_off:false},0).to({_off:true},10).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({_off:true},10).wait(7));
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{"in":0,"stop":37});
	...
	// ShareClips
	this.shareClips = new lib.ShareClips();
	this.shareClips.parent = this;
	this.shareClips.setTransform(452.1,154.8,1,1,0,0,0,452.1,154.8);

	this.timeline.addTween(cjs.Tween.get(this.shareClips).wait(68));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:914.6,regY:236.4,x:394.4,y:257.4,startPosition:10},10).to({regX:914.5,regY:236.2,x:385.6,y:283.2,startPosition:15},5).wait(53));

	// レイヤー 1
	this.instance_1 = new lib.SharePig("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(383.8,377.8);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(3).to({_off:false},0).wait(2).to({startPosition:0},0).to({x:386.4,y:146.4},5).wait(5).to({startPosition:0},0).to({x:159.6,y:138.7},5).wait(5).to({startPosition:0},0).to({x:167.1,y:73.9},4).wait(39));

	// レイヤー 4
	this.instance_2 = new lib.WhiteBox("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(384,240.1,0.02,0.027,0,0,0,0,222.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regY:221.1,scaleX:0.27,scaleY:0.24,y:381.5},3).wait(2).to({startPosition:0},0).to({regY:220.8,scaleX:0.29,scaleY:0.64,y:240.1},5).wait(5).to({y:227.6},0).to({regY:220.9,scaleX:1,scaleY:0.68,y:240.1},5).wait(5).to({startPosition:0},0).to({regY:220.8,scaleY:1,y:240},4).wait(39));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(130.4,-123.8,773.9,377.8);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(488.7,406.2);
	...
	this.instance_6.parent = this;
	this.instance_6.setTransform(650.8,234.2,0.25,0.25,-3.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_5}]},47).to({state:[{t:this.instance_6}]},7).wait(42));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(47).to({_off:false},0).to({_off:true,regY:0,scaleX:0.25,scaleY:0.25,rotation:-3.7,x:650.8,y:234.2},7,cjs.Ease.get(-0.99)).wait(42));
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// レイヤー 2
	this.instance = new lib.LW("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(463.6,292.5,1,1,2.7,0,0,0.1,94.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// MainText_in
	this.instance_1 = new lib.MainText_stay("synched",11,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(384,54.5,1,1,0,0,0,384,54.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// MainTitleText
	this.instance_2 = new lib.MainTitleText("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(674.2,54.7,1,1,0,0,0,55.6,24.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// Aphorism_Nietzsche
	this.instance_3 = new lib.Aphorism_Nietzsche("synched",95,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(99.9,-1,1,1,0,0,0,99.9,-1);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance = new lib.LW("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(442.5,289.6,0.055,0.055,-90,0,0,0,95);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(105).to({_off:false},0).to({regX:0.1,regY:94.5,scaleX:1,scaleY:1,rotation:2.7,x:463.6,y:292.5},11,cjs.Ease.get(1)).wait(1));

	// Wave
	this.instance_1 = new lib.Polar_multi("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(419.9,255.5,0.017,0.009,21.9);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(26).to({_off:false},0).to({scaleX:0.38,scaleY:0.21,rotation:21.8,x:419.8,y:255.8,alpha:0.68,startPosition:16},16,cjs.Ease.get(1)).to({scaleX:0.47,scaleY:0.26,y:255.9,alpha:0.602,startPosition:29},13).to({regX:0.3,regY:0.4,scaleX:0.48,scaleY:0.26,rotation:22,y:255.8,alpha:0,startPosition:33},4,cjs.Ease.get(-1)).to({_off:true},40).wait(18));

	// MainText_in
	this.instance_2 = new lib.MainText_in("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(384,54.5,1,1,0,0,0,384,54.5);

	this.instance_3 = new lib.MainText_stay("synched",11,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(384,54.5,1,1,0,0,0,384,54.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},95).to({state:[{t:this.instance_3}]},21).wait(1));

	// レイヤー 3
	this.instance_4 = new lib.ExtendBlurs("synched",0,false);
	this.instance_4.parent = this;
	this.instance_4.setTransform(669.5,70.9,1,0.682,-48.5,0,0,0,15.1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(98).to({_off:false},0).to({_off:true},18).wait(1));

	// MainTitleText
	this.instance_5 = new lib.MainTitleText("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(664.2,49.5,0.129,0.129,0,0,0,55.5,24.4);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(105).to({_off:false},0).to({regX:55.6,regY:24.3,scaleX:1,scaleY:1},9,cjs.Ease.get(0.97)).wait(2).to({startPosition:0},0).wait(1));

	// Aphorism_Nietzsche
	this.instance_6 = new lib.Aphorism_Nietzsche("synched",0,false);
	this.instance_6.parent = this;
	this.instance_6.setTransform(99.9,-1,1,1,0,0,0,99.9,-1);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(116).to({startPosition:95},0).wait(1));
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shareButton.parent = this;
	this.shareButton.setTransform(48,336,0.4,0.4,0,0,0,100,100);

	this.timeline.addTween(cjs.Tween.get(this.shareButton).wait(2));

	// menuPanel
	this.menuPanel = new lib.MenuPanel();
	this.menuPanel.parent = this;
	this.menuPanel.setTransform(390.9,225.2,1,1,0,0,0,390.9,225.2);

	this.timeline.addTween(cjs.Tween.get(this.menuPanel).wait(2));

	// sharePanel
	this.sharePanel = new lib.SharePanel();
	this.sharePanel.parent = this;
...
})(gCjsNavigationLib = gCjsNavigationLib||{}, gCjsNavigationImages = gCjsNavigationImages||{}, createjs = createjs||{}, ss = ss||{});
var gCjsNavigationLib, gCjsNavigationImages, createjs, ss;